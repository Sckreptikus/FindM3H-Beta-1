...
banner() {
 ...
 printf "                                                   \e[1;92m.-\"\"\"\"-. \e[0m\n"
  printf "                                                   \e[1;92m/        \ \e[0m\n"
  printf "\e[1;77m  ___   _   _ __    ____    _ ___  ___ _     _     _   _    \e[0m\e[1;92m   fuc    \e[0m\n"
  printf "\e[1;77m |  _| | | | '_  \ |  _ \  | '_  \/  _' |  _| |   | |_| |   \e[0m\e[1;92m  |___|   \e[0m\n"
  printf "\e[1;77m | |_  | | | | | | | | | | | | |____| | | |__ |   |     |   \e[0m\e[1;92m    |     \e[0m\n"
  printf "\e[1;77m | __| | | | | | | | |_| | | |        | |  _| |   |  _  |    \e[0m\e[1;92m   |     \e[0m\n"
  printf "\e[1;77m |_|   |_| |_| |_| |____/  |_|        |_| |___|   |_| |_|  \e[0m\e[1;92m           \e[0m\n"
  printf "                   \e[1;92mv1.0, Author: @anonhack990, Origional: @linux_choice  \e[0m     \e[1;92m\  __  / \e[0m\n"
...
check1=$(curl -s -i "https://vsco.co/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://vsco.co/$username" $username
printf "https://vsco.co/$username" $username >> $username.txt
fi

## 500px

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] 500px: \e[0m"
check1=$(curl -s -i "https://500px.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://500px.com/$username" $username
printf "https://500px.com/$username" $username >> $username.txt
fi

## swng.me

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] SW/NG: \e[0m"
check1=$(curl -s -i "https://swng.me/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://swng.me/$username" $username
printf "https://swng.me/$username" $username >> $username.txt

## Steller 

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Steller: \e[0m"
check1=$(curl -s -i "https://steller.co/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://steller.co/$username" $username
printf "https://steller.co/$username" $username >> $username.txt

## ArtFixed

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] ArtFixed: \e[0m"
check1=$(curl -s -i "https://ArtFixed/author/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://ArtFixed/author/$username" $username
