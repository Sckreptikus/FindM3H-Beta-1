...
#
UserRecon v1 .0# Author: @linux_choice# https: //github.com/thelinuxchoice/userrecon
  #Give me the credits
if you use any part of this code, read the License.
...
scanner() {
    ...
    read - p $ '\e[1;92m[\e[0m\e[1;77m?\e[0m\e[1;92m] Input Username:\e[0m '
    username
    ...
    check_insta = $(curl - s - H "Accept-Language: en"
      "https://www.instagram.com/$username" - L | grep - o 'The link you followed may be broken'; echo $ ? )
    ...
    check1 = $(curl - s - i "" - H "Accept-Language: en" - L | grep - o 'HTTP/2 404\|404 Not Found'; echo $ ? )
    ...
    printf "\e[1;92m Found!\e[0m https://vsco.co/$username"
    $username
    printf "https://vsco.co/$username"
    $username >> $username.txt
    fi
    ...
    printf "\e[1;92m Found!\e[0m https://500px.com/$username"
    $username
    printf "https://500px.com/$username"
    $username >> $username.txt
    ...
    printf "\e[1;92m Found!\e[0m https://swng.me/$username"
    $username
    printf "https://swng.me/$username"
    $username >> $username.txt
    ...
    printf "\e[1;92m Found!\e[0m https://steller.co/$username"
    $username
    printf "https://steller.co/$username"
    $username >> $username.txt
    ...
    printf "\e[1;92m Found!\e[0m https://ArtFixed.com/author/$username"
    $username
    printf "https://ArtFixed/author/$username"
    $username >> $username.txt
